...
public class BaseServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        //完成方法分发    浏览器访问：http://localhost/travel/user/find
        String uri = request.getRequestURI(); //获得请求路径 /travel/user/findOne
        String methodName = uri.substring(uri.lastIndexOf("/")+1); //获得访问的方法名
